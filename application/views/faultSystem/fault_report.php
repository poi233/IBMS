                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <fieldset class="form-horizontal">
                                        <div class="form-group"><label class="col-sm-2 control-label">缺陷名称:</label>
                                            <div class="col-sm-10"><input type="text" class="form-control" placeholder="Fault name"></div>
                                        </div>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">被测对象:</label>
                                            <div class="col-sm-10"><input type="text" class="form-control" placeholder=""></div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">下步处理安排:</label>
                                            <div class="col-sm-10"><input type="text" class="form-control" placeholder=""></div>
                                        </div>

                                        <div class="row">
                                            <div class="col-xs-12">
                                                <button class="btn btn-primary pull-right" type="submit">提交缺陷</button>
                                            </div>
                                        </div>
                                    </fieldset>
